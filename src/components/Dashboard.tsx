...
export const Dashboard: React.FC<React.PropsWithChildren> = ({ children }) => {
  ...
  const [navigation, setnavigation] = useState([
    ...
    { name: 'Histórico', href: '/history', icon: ClockIcon, current: false },
    {
      name: 'Produtos',
      href: '/products',
    ...
    { name: 'Remessa', href: '/shipping', icon: UserGroupIcon, current: false },
    // {
    //   name: 'Validades',
    //   href: '/validity',
  ...
  const secondaryNavigation = [
    ...
    { name: 'Privacidade', href: '/privacy', icon: ShieldCheckIcon },
  ];
  ...
  useEffect(() => {
    setnavigation(
      navigation.map((item) => {
        if (
          (asPath.match(item.href) && item.href !== '/') ||
          asPath === item.href
        ) {
              ...
              >
                <Dialog.Panel className="relative flex w-full max-w-xs flex-1 flex-col bg-cyan-700 pt-5 pb-4">
                  ...
                  <div className="flex flex-shrink-0 items-center px-4">
                    <Image
                      loader={({ src }) =>
                        `https://tailwindui.com/img/logos/${src}?color=cyan&shade=300`
                      }
                      src="mark.svg"
                      alt="Easywire logo"
                      width={32}
              ...
              {/* <div className="mt-auto pt-6">
                <div className="space-y-1 px-2">
                  <label className="w-full">
                    <input
                      type="date"
                      className="w-full rounded-md px-2 py-2 text-sm font-medium leading-6"
                      // value={date}
